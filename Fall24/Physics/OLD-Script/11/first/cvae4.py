...
LEARNING_RATE = 0.0006712353825366824
PATIENCE = 20
MIN_DELTA = 0.0009127092901852043

# Encoder and Decoder architecture configuration
ENCODER_LAYERS = [335, 335]  # Encoder hidden layers
DECODER_LAYERS = [335, 335]  # Decoder hidden layers
...
momenta_normalized = momenta  # If you want to normalize momenta as well, you can add a scaler for it
...
print(f"Test MRE: {mre:.4f}")  # Added MRE output
