...
rng = 0
data_x = pd.read_csv('/home/g/ghanaatian/MYFILES/FALL24/Physics/8thGitCinn/MatDesINNe/Simulated_DataSets/MoS2/data_x.csv', header=None).values
data_y = pd.read_csv('/home/g/ghanaatian/MYFILES/FALL24/Physics/8thGitCinn/MatDesINNe/Simulated_DataSets/MoS2/data_y.csv', header=None).values
