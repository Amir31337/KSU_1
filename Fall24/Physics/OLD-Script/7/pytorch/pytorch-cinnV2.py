...
Average MSE across 5 folds: 2.0968
'''
...
BATCH_SIZE = 512  # Updated
N_EPOCHS = 1253  # Updated
LR_INIT = 0.0002431813414681301  # Updated
LATENT_DIM = 9
POSITION_DIM = 9
MOMENTA_DIM = 9
GRAD_CLAMP = 50.06594573684893  # Updated
K_FOLDS = 5

# Model architecture
SUBNET_HIDDEN_DIM = 128  # Updated
NUM_COUPLING_BLOCKS = 9  # Updated
COUPLING_CLAMP = 0.1300476400506438  # Updated
