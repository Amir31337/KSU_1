...
Average MSE across 5 folds: 1.8219'''
...
N_EPOCHS = 263  # Updated
LR_INIT = 8.599003038433948e-05  # Updated
LATENT_DIM = 9
POSITION_DIM = 9
MOMENTA_DIM = 9
GRAD_CLAMP = 54.106715497829555  # Updated
K_FOLDS = 5

# Model architecture
SUBNET_HIDDEN_DIM = 512  # Updated
NUM_COUPLING_BLOCKS = 2  # Updated
COUPLING_CLAMP = 0.725788498003067  # Updated
